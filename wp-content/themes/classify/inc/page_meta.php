...
function wpcrown_page_metabox( $post )
{
	...
	<div style="padding:20px 0;">
		...
		jQuery(document).ready(function(){ 
			...
			if( val === "default" || val === "template-full-width.php" || val === "template-homepage-v1.php"  || val === "template-tag.php"  || val === "template-homepage-v2.php" || val === "template-left-sidebar.php" || val === "template-pricing-plans.php" || val === "template-listing-homepage-sidebar.php" || val === "template-listing-homepage.php" ) {
