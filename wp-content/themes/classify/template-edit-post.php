				...
				<div id="upload-ad" class="ad-detail-content">
					...
					<form class="form-item" action="" id="primaryPostForm" method="POST" enctype="multipart/form-data">
						...
						<?php } ?>
							...
							<input type="text" id="postTitle" name="postTitle" value="<?php echo $title; ?>" size="60" maxlength="255" class="form-text required input-textarea half">
						...
						<?php
				      	...
				      	<?php } ?>
							...
							<input type="text" id="post_price" name="post_price" value="<?php echo $post_price; ?>" size="12" maxlength="10" class="form-text required input-textarea half">
							<?php
							...
							?>
							<input type="text" id="post_location" name="post_location" value="<?php echo $post_location; ?>" size="12" maxlength="110" class="form-text required input-textarea half">
						<?php } ?>
						<?php 
						...
						<div id="map-container">
							...
							<input type="text" id="latitude" name="latitude" value="<?php echo $post_latitude; ?>" size="12" maxlength="10" class="form-text required input-textarea half">


							<input type="text" id="longitude" name="longitude" value="<?php echo $post_longitude; ?>" size="12" maxlength="10" class="form-text required input-textarea half">
						...
						<fieldset class="input-title">
							...
							<label for="edit-field-category-und" class="control-label"><?php _e('Add Images', 'agrg') ?></label>
