...
?>
    ...
    <section id="featured-abs-author">
        ...
        <div class="container">
            ...
            <h2 class="main-title">"<?php echo get_the_author_meta('display_name', $user_ID ); ?>" <?php _e( 'PREMIUM ADVERTISEMENT', 'agrg' ); ?></h2>
    ...
    <section id="ads-profile">
        ...
        <div class="container">
        	...
        	<h2 class="main-title" style="text-transform:uppercase;">"<?php echo get_the_author_meta('display_name', $user_ID ); ?>" <?php _e( 'PREMIUM REGULAR ADS', 'agrg' ); ?></h2>
